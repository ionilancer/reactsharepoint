  ...
  public render(): React.ReactElement<FormnuevodesmontajeProps> {
    ...
    return (
      <div className={styles.formdesmontajes}>
       ...
       <Txtinput name="Fecha registro"  tipo="number" disabled={true} internalName="fecharegistro" value={fechaYHora} />
       <Txtinput name="Usuario"  tipo="number"disabled={true} internalName="usuario"  value="" />
       <Txtinput name="Departamento"  tipo="number"disabled={true} internalName="departamento"  value="" />
       <Txtinput name="Fecha registro"  tipo="number"disabled={true} internalName="fecharegistro" value={fechaYHora} />
       <Txtinput name="Nº contrato (billing)"  tipo="number" disabled={true} internalName="numcontrato"  value="" />
       <Txtinput name="Nº contrato antiguo (venta cruzada)" tipo="number"disabled={false} internalName="numcontratoantiguo"  value="" />
       <Txtinput name="Fecha instalación" tipo="number" disabled={true} internalName="fechainstalacion" value={fecha} />
       ...
       <Txtinput name="Status monitoring inicial"  tipo="number"disabled={true} internalName="statusmonitoringinicial" value="" />
       <Txtinput name="Status billing inicial"  tipo="number"disabled={true} internalName="statusbillinginicial" value="" />
       ...
       <Txtinput name="Fecha cambio status de billing final"  tipo="number"disabled={false} internalName="fechacambiostatusbillingfinal" value={fecha} />
       <Txtinput name="Antigüedad del cliente"  tipo="number"disabled={true} internalName="antiguedaddelcliente"  value="" />
       <Txtinput name="Panel" disabled={true} tipo="number" internalName="panel"  value="" />
       ...
       <Txtinput name="Fecha límite por reclamación consumo" tipo="number" disabled={true} internalName="fechalimitereclamaciónconsumo" value={fechaYHora} />
        <Dropdown name="Penalización" site={this.props.site} default={null}  lista="" disabled={false} internalName="penalización" opciones={opcionesCheck}/>
        ...
        <Txtinput name="Matrícula comercial"  tipo="number" disabled={true} internalName="matrículacomercial"  value="" />
        ...
        <Txtinput name="Importe de abono"  tipo="number"disabled={true} internalName="importeabono"  value="" />
        <Txtinput name="Factura a abonar"  tipo="number"disabled={true} internalName="facturaabonar"  value="" />
        <Txtinput name="Importe a devolver de instalación y/o mantenimiento" tipo="number" disabled={true} internalName="importedevolvernstalacionmantenimiento "  value="" />
        <Txtinput name="Importe a devolver por cuotas" tipo="number" disabled={true} internalName="importedevolverporcuotas"  value="" />
        ...
        <Txtinput name="Importe total a devolver"  tipo="number"disabled={true} internalName="importedevolvernstalacionmantenimiento "  value="" />
        ...
        <Txtinput name="Nombre cliente"  tipo="number"disabled={true} internalName="nombrecliente"  value="" />
        <Txtinput name="DNI / CIF cliente"  tipo="number"disabled={true} internalName="dnicif"  value="" />
        <Txtinput name="IBAN" disabled={true}  tipo="number"internalName="iban"  value="" />
        <Txtinput name="BIC / SWIFT" tipo="number" disabled={true} internalName="bicfwift"  value="" />
        <Txtinput name="Verificación telefónica desmontaje" tipo="number" disabled={true} internalName="verificaciontelefonicadesmontaje"  value="" />
        <Txtinput name="Fecha entrada parte de servicio" tipo="number" disabled={true} internalName="fechaentradaparteservicio"  value={fecha} />
        <Txtinput name="Comentarios generales" tipo="number" disabled={true} internalName="comentariosgenerales"  value="" />
        <Txtinput name="Price list" tipo="number" disabled={true} internalName="pricelist"  value="" />
        <Txtinput name="Subtype" tipo="number" disabled={true} internalName="Subtype"  value="" />
        <Txtinput name="Sales type" tipo="number" disabled={true} internalName="salestype"  value="" />
        <Txtinput name="Member" tipo="number" disabled={true} internalName="member"  value="" />
        </div>
        </div>
      </div>
    );
